...
export function Home() {
  return <div className="home-page"><Seo title="Ian Ortega | Curious by Nature" description="Meet Ian Ortega: a curious builder, explorer, and creative thinker working across technology, engineering, human performance, and adventure." />
    <section className="home-hero human-hero"><MediaPlaceholder src={`${import.meta.env.BASE_URL}images/Pictures/Turtle_Hero_Balanced.png`} alt="Ian Ortega scuba diving beneath a sea turtle" className="hero-media" eager /><div className="hero-scrim" /><div className="hero-content"><span className="route-label">01 / A HUMAN IN PROGRESS</span><h1>Ian<br />Ortega</h1><p className="identity">Curious by nature / restless by choice</p><p className="hero-copy">I follow interesting questions across disciplines, build things to see what is possible, and collect a few good stories along the way.</p></div><div className="hero-field-note" aria-label="Apo Reef, Philippines. Coordinates 12 degrees 39 minutes 42 seconds north, 120 degrees 24 minutes 52 seconds east."><div><span>Coordinates:</span></div><strong>12°39′42″ N<br />120°24′52″ E</strong><p>Apo Reef, Philippines</p></div><a className="scroll-cue" href="#introduction"><span>Meet Ian</span><ArrowDown /></a></section>
