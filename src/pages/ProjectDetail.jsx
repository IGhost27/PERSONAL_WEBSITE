...
export function ProjectDetail() {
  ...
  return (
    <article className="case-page">
      <Seo
        title={`${project.title} | Ian Ortega`}
      ...
      <header className="case-hero page-shell">
        ...
        <MediaPlaceholder
          ...
          label={`Add ${project.title} hero media`}
        />
      </header>
          ...
          <section>
            ...
            <div className="case-gallery">
              <MediaPlaceholder
                ...
                label="Add process photograph or diagram"
              />
              <MediaPlaceholder
                alt={`${project.title} detail`}
                label="Add result, CAD, or research figure"
              />
            </div>
          </section>
        </div>
